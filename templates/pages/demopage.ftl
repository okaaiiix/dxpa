...
<html xml:lang="${cmsfn.language()}" lang="${cmsfn.language()}">
  <head>
    ...
    [#-- To load resources you can link them manually (e.g. line below) --]
      [#-- <link rel="stylesheet" type="text/css" href="${ctx.contextPath}/.resources/dxpa/webresources/css/bootstrap.css" media="all" /> --]
      [#-- <script src="${ctx.contextPath}/.resources/dxpa/webresources/js/jquery.js"></script> --]
    [#-- or via theme --]
  ...
  <body class="demopage ${cmsfn.language()}">

    <div class="container">
      <h1>demopage works!</h1>
    </div>
